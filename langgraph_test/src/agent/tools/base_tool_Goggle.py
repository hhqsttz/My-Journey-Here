...
class name(BaseModel):
    a : str = Field(description="这个是一个人名")
...
print(say_bye.name)
print(say_bye.description)
print(say_bye.args)
print(say_bye.args_schema)#pytandic对象
print(say_bye.args_schema.model_json_schema())#pytandic对象转化成json对象
